    ...
    <head>
        ...
        <script type="text/javascript">
	        function fileCheck(){
	            ...
	            var titleVal = $("input[name='gtitle']").val(); // 제목 값 가져오기
	            var contentVal = $("textarea[name='gcontent']").val();
	        	이 방식은 name으로 가져오는 방식
        ...
        <section class="page-section" id="my-info">
            <div class="d-flex justify-content-center">
               	<div class="text-center">
               		<form action="./galleryInsert" id="upimg" method="post" enctype="multipart/form-data" onsubmit="return fileCheck()">
               			...
               			<div class="input-group mb-3" style="height: 300px">
  							...
  							<textarea class="form-control" id="gallerycontent" aria-label="With textarea" name="gcontent"></textarea>
						</div>
						<div class="input-group mb-3">
						  	<input type="file" accept="image/*" id="file1" name="uploadingFile" class="form-control">
						</div>
						<div class="input-group mb-3">
